...
public class GetOrders extends ApiRequest<Order[]> {
    ...
    public GetOrders(int id, Response.Listener<Order[]> listener, @Nullable Response.ErrorListener errorListener) {
        super(String.format("stand/%d/orders", id), Method.GET, listener, errorListener);
    }
